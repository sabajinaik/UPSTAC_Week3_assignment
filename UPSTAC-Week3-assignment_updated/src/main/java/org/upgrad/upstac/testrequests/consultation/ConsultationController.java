...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        return testRequestQueryService.findBy(RequestStatus.LAB_TEST_COMPLETED); //<Sabaji><02/27/2021>
    }
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        return testRequestQueryService.findByDoctor(userLoggedInService.getLoggedInUser()); //<Sabaji 02/27/2021>
    }
